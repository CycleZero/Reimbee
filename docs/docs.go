        ...
        "/api/chat/stream": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "会话ID（UUID v7），同一会话多次请求复用此 ID",
                        "name": "session_id",
                        "in": "query",
                        "required": true
                    },
                    ...
                    {
                        "type": "string",
                        "description": "Bearer JWT Token（由 /api/auth/login 签发）",
                        "name": "Authorization",
                        "in": "header",
                        "required": true
                    }
                ...
                "responses": {
                    ...
                    "500": {
                        "description": "服务器不支持流式响应（http.Flusher 不可用）",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
                    ...
                    "503": {
                        "description": "服务繁忙（TurnLoop 已停止，无法接收新消息）",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
